---
title: QUDA CUDA 12 milc-cg stack on Perlmutter
...
load_when: Rebuilding or validating the quda-cuda12-milc-cg-2026q3 stack.
evidence: source
sources:
...
# QUDA CUDA 12 `milc-cg` on Perlmutter
