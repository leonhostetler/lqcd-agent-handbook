...
| [Reading GPU profile metrics](profile-metrics.md) | What each extracted profile quantity means, how idle time is attributed and what its residual does and does not prove, what a tracer cannot establish, what tracing itself changes about the run and about a comparison between two runs, and the readings that are unfounded on trace data alone. | Reading, quoting, or reasoning about any quantity extracted from a GPU profiler database. |
