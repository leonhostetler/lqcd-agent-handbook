...
- `conventions/` — shared HISQ vocabulary, running, and measurement rules.
- `modes/` — current work-mode and handbook-mode behavior.
- `machines/` — site capabilities, node types, stacks, and incidents.
