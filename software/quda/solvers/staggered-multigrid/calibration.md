...
| Coarse-spectrum law | 49 distinct converged `(spacing, V3, nvec_2, nvec_3, mass)` cells: 23 at 0.04 fm and 26 at 0.06 fm. The envelope is `nu3 = 0.022...0.250` and `m = 0.000569...0.015550`. Of those 49 fitted cells, `nvec_2 = 96` in 45, `64` in three, and `128` in one; all four non-96 cells are at 0.06 fm, so the population weakly constrains `nvec_2` dependence. The 0.09-fm cells are outside the fit and are diagnostic only. |
